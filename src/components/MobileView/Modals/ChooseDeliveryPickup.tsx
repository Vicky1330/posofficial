...
interface PickupDeliverModalProps {
    goBack: () => void;
    // insertUpdatePickupStatus: (status: number) => void;
}

const ChooseDeliveryPickup: React.FC<PickupDeliverModalProps> = ({ goBack }) => {
    ...
    return (
        <div
            className="modal modal-back fade show"
            id="s_pickup"
                            ...
                            >
                                ...
                                >
                                    ...
                                    // to={`/${restaurantName}/departments`}
                                        className="boxone flex justify-center items-center flex-column hover:scale-105 duration-200 ease-in-out transform transition-transform "
                                ...
                                >
                                    <button className="boxone flex justify-center items-center flex-column hover:scale-105 duration-200 ease-in-out transform transition-transform"
                                        onClick={handleDate}
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                ...
                                {scheduleLater ? (
                                    <div
                                        className={`row justify-content-center p-2 translate-x-2.5 ${scheduleLater ? "opacity-100" : "opacity-0"} transition-opacity duration-1000 ease-in-out`}
                                        id="scheduleOrderOptions_Modal_MobileView"
                                    >
                                        <div className="flex space-y-4 flex-col">
                                            <div className="pl-1">
                                                <select
                                                    id="ddlScheduleDate_ModalMobileView"
                                                    className="ddlScheduleDate p-1 w-full border-black"
                                                    value={selectedDate}
                                            ...
                                            <div className="pl-1">
                                                <select
                                                    ...
                                                    className="ddlScheduleDate p-1 w-full"
                                                    value={selectedTime}
...
export default ChooseDeliveryPickup;
