...
const AddPromocodeModal: React.FC<Props> = ({
  onClose,
  promoCodeId,
  promoCodeData,
}) => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!promoCodeName.trim())
      newErrors.promoCodeName = "Promo code name is required";
  ...
  const handleSubmit = async () => {
    if (validateForm()) {
      ...
      }api/add/update/promocodes?restaurantLoginId=${RestaurantLoginId_Global}`;
      try {
  ...
  useEffect(() => {
    if (promoCodeId !== 0) {
      ...
      setPromoCodeTimingTypeId(
        String(promoCodeData.PromoCodeTimingTypeId || "1")
      );
      ...
      if (
        promoCodeData &&
        promoCodeData.PromoCodeTimings &&
        promoCodeData.PromoCodeTimings.length > 0
      ) {
  ...
  return (
    ...
    >
      <div className="modal-dialog modal-lg modal-dialog-centered">
        <div className="modal-content w-100 max-h-[550px] sm:max-h-full">
                        ...
                        {[
                          ...
                          <li key={day}>
                            <div>
                              ...
                              />
                              <label htmlFor={`promoCodeTiming${day}`}>
                                {day.slice(0, 3)}
                              </label>
                            </div>
                          </li>
