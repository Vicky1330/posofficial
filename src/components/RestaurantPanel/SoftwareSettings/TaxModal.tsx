...
const TaxModal: React.FC<Props> = ({ closeModal, taxId, setLoading }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}api/addupdate/tax`,
        formData,
        {
          headers: {
  ...
  const getTaxDataById = async (Id: number) => {
    ...
    }api/single/tax?taxId=${Id}&restaurantLoginId=${restaurantLoginId}`;
    try {
  ...
  return (
    <>
      ...
      <div
        ...
        id="ShowAddUpdateTaxModal_ManageSoftwareSetting"
        tabIndex={-1}
        role="dialog"
        ...
        <div className="modal-dialog modal-dialog-centered" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="heading_Title_TaxModal">
                Create Tax
              </h5>
            </div>
            <div className="modal-body" style={{ height: "273px" }}>
              <form>
                <div className="form-group">
                  <label htmlFor="textTaxName_ManageSoftwareSetting">
                    Name
                  </label>
                  <input
                    type="text"
                    className="form-control"
                    id="textTaxName_ManageSoftwareSetting"
                    value={taxName}
                  ...
                  <div
                    ...
                    id="errorMsg_TaxName_ManageSoftwareSetting"
                  >
                    {errorMsg}
                  </div>
                </div>
                <div className="form-group">
                  <label htmlFor="textTaxRateValue_ManageSoftwareSetting">
                    Tax Rate (%)
                  </label>
                  <input
                    type="text"
                    className="form-control IsDecimal"
                    id="textTaxRateValue_ManageSoftwareSetting"
                    value={taxRateValue}
                  ...
                  <div
                    className="errorsClass2"
                    id="errorMsg_TaxRateValue_ManageSoftwareSetting"
                  >
                    {errorMsg}
                  </div>
                </div>
                ...
                >
                  ...
                  <select
                    id="ddlTaxType_ManageSoftwareSetting"
                    value={taxType}
                  ...
                  <div
                    className="errorsClass2"
                    id="error_ddlTaxType_ManageSoftwareSetting"
                  >
                    {errorMsg}
                  </div>
                </div>
            ...
            <div className="modal-footer !flex !flex-row gap-3">
              <button
                type="button"
                className="pro-cancel m-0"
                onClick={closeModal}
              >
                Cancel
              </button>
              <button
                id="btnSubmit_Tax_ManageSetting"
                type="button"
                className="pro-submit m-0"
